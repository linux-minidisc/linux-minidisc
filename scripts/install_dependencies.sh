...
case "$BUILD_TYPE" in
    ...
    linux)
        ...
        sudo apt-get install -q -y \
            ...
            libglib2.0-dev libmad0-dev libgcrypt20-dev libusb-1.0-0-dev libtag1-dev libjson-c-dev \
            meson ninja-build cmake
        ;;
    macos)
        brew update
        for pkg in pkg-config qt@5 mad libtag glib libusb libusb-compat libgcrypt meson ninja cmake json-c; do
